...
== Term of Privacy ==
This plugin is call to external service Line Messaging API it use to be send an order data to your line messager account or line group depend on your token.